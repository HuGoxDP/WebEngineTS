...
**112 of 175 classes walked — parts 1 to 6 complete, part 7 two thirds done.** Live counts are in [`checklist.md`](checklist.md#progress); the
...
| 7 | UI controls | 18 | in progress — 12 walked, 3 findings |
| 8–10 | everything else | 58 | not started |
