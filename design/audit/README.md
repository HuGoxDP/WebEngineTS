...
**129 of 175 classes walked — parts 1 to 7 complete, part 8 has `Ray` left.** Live counts are in [`checklist.md`](checklist.md#progress); the
...
| 8 | Math | 12 | in progress — 11 walked, 3 findings |
