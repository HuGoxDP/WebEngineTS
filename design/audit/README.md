...
**61 of 175 classes walked — parts 1 to 3 complete, part 4 has one class left.** Live counts are in [`checklist.md`](checklist.md#progress); the
...
| 4 | Assets and scenario | 12 | in progress — 11 walked, 10 findings |
