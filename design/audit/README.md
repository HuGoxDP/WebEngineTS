...
**90 of 175 classes walked — parts 1 to 5 complete, part 6 over half done.** Live counts are in [`checklist.md`](checklist.md#progress); the
...
| 6 | UI core | 21 | in progress — 12 walked, 6 findings |
