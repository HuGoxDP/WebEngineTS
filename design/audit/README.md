...
**107 of 175 classes walked — parts 1 to 6 complete, part 7 well under way.** Live counts are in [`checklist.md`](checklist.md#progress); the
...
| 7 | UI controls | 18 | in progress — 7 walked, 2 findings |
