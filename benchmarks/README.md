...
| `relSrc` | scenario | `0` | Release decoded source images after load (`Resources.releaseAllSourceImages()`) — Scene 3 row 3.4 |
| `ktx2` | scenario | `0` | Prefer `.ktx2` compressed textures when present (`Resources.preferExtension`) — Scene 3 KTX2 row; needs a dual-format ZIP |
